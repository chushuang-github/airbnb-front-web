...
const IconColse = memo((props) => {
  const { width = 12, height = 12 } = props
  return (
    <svg viewBox="0 0 24 24" role="img" aria-hidden="false" aria-label="关闭" focusable="false" style={styleStrToObject(`height: ${height}px; width: ${width}px; display: block; fill: rgb(255, 255, 255);`)}>
